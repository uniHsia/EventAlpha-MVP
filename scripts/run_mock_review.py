"""Run the EventAlpha-MVP mock review demo."""
...
def main() -> None:
    """Review the latest ledger entry with mock T+3 market data."""
    parser = ArgumentParser(description="Run EventAlpha-MVP mock review pipeline.")
    ...
    print(f"EventAlpha-MVP Demo: mock {args.horizon} 多资产复盘")
    _print_model("读取预测账本", prediction)
    print(f"\n## mock {args.horizon} 市场表现")
